...
#     NO_META => q[1]
#     PREREQ_PM => { Config::General=>q[0], Moose=>q[0], Test::More=>q[0.88], Catalyst::View::TT=>q[0], Acme::LOLCAT=>q[0], Catalyst::Action::RenderView=>q[0], namespace::autoclean=>q[0], Catalyst::Runtime=>q[5.90103], Catalyst::View::JSON=>q[0], Catalyst::Plugin::Static::Simple=>q[0], ExtUtils::MakeMaker=>q[6.36], Catalyst::Plugin::ConfigLoader=>q[0], Catalyst::Plugin::Unicode=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
...
INSTALLARCHLIB = $(PERLPREFIX)/lib/i386-linux-gnu/perl/5.20
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = $(SITEPREFIX)/lib/i386-linux-gnu/perl/5.20.2
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = $(VENDORPREFIX)/lib/i386-linux-gnu/perl5/5.20
...
pure_all :: $(INST_SCRIPT)/lolcatalyst_lite_cgi.pl $(INST_SCRIPT)/lolcatalyst_lite_server.pl $(INST_SCRIPT)/lolcatalyst_lite_fastcgi.pl $(INST_SCRIPT)/lolcatalyst_lite_create.pl $(INST_SCRIPT)/lolcatalyst_lite_test.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/lolcatalyst_lite_cgi.pl $(INST_SCRIPT)/lolcatalyst_lite_server.pl \
	  $(INST_SCRIPT)/lolcatalyst_lite_fastcgi.pl $(INST_SCRIPT)/lolcatalyst_lite_create.pl \
	  $(INST_SCRIPT)/lolcatalyst_lite_test.pl 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>moussaid,,,</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE VERSION="5.90103" NAME="Catalyst::Runtime" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="i586-linux-gnu-thread-multi-64int-5.20" />' >> $(DISTNAME).ppd
...
upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Acme::LOLCAT,0,Catalyst::View::JSON,0,Catalyst::Plugin::Unicode,0,Test::More,0.88,Catalyst::Runtime,5.90103,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0,Catalyst::View::TT,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Acme::LOLCAT,0,Catalyst::View::JSON,0,Catalyst::Plugin::Unicode,0,Test::More,0.88,Catalyst::Runtime,5.90103,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0,Catalyst::View::TT,0
